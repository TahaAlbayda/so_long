...
/*   Updated: 2024/08/06 13:46:49 by tal-bayd         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	check_rows(t_game *game)
{
	...
	while (i < game->map.rows)
	{
		...
		if (game->map.full_map[i][game->map.columns - 1] != WALL)
...
void	ft_check_columns(t_game *game)
{
	...
	while (i < game->map.columns)
	{
		...
		of wall", game);
		if (game->map.full_map[game->map.rows - 1][i] != WALL)
